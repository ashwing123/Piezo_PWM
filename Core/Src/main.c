...
int main(void)
{
  ...
  char pirates_of_carribean_notes[] = "E4 G4 A4 A4 0 A4 B4 C5 C5 0 C5 D5 B4 B4 0 "
  		  "A4 G4 A4 0 E4 G4 A4 A4 0 A4 B4 C5 C5 0 C5 D5 B4 B4 0 A4 G4 A4 0 "
  		  "E4 G4 A4 A4 0 A4 C5 D5 D5 0 D5 E5 F5 F5 0 E5 D5 E5 A4 0 A4 B4 C5 C5 0 D5 E5 A4 0 "
  		  "A4 C5 B4 B4 0 C5 A4 B4 0 A4 A4 "
